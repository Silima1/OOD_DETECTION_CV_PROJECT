...
def main():
    ...
    plt.title("UMAP visualization of learned feature space")
    plt.legend(markerscale=2)
    plt.grid(alpha=0.2)
    plt.tight_layout()

    save_path = "results/tsne_umap/umap_cifar10_ood_features.png"
    plt.savefig(save_path, dpi=300)
    plt.close()

    print("Figura UMAP guardada em:", save_path)
