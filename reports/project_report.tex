...
\begin{itemize}
    ...
    \item the repository currently does not include a \texttt{requirements.txt} file, although the Dockerfile expects one;
    \item the raw data are not included in the repository.
\end{itemize}
...
\begin{itemize}
    ...
    \item create a dependency file and reproducible configuration files.
\end{itemize}
